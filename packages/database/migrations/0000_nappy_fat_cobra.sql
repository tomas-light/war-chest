...
CREATE TABLE "game_participants" (
	...
	CONSTRAINT "game_participants_role_seat_check" CHECK (("game_participants"."role" = 'player' AND "game_participants"."seat" IS NOT NULL) OR ("game_participants"."role" = 'spectator' AND "game_participants"."seat" IS NULL)),
...
CREATE UNIQUE INDEX "game_participants_game_seat_unique" ON "game_participants" USING btree ("game_id","seat");--> statement-breakpoint
