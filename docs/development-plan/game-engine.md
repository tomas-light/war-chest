...
В рамках подготовки полной игры уже согласованы
[дуэльный и командный форматы, базовая игра и дополнения](../game-engine/gameModes.md),
а также [Random, Draft и Elimination Draft](../game-engine/cardSelection.md).
Эти требования относятся к движку и описаны по обсуждениям и макетам Figma
7–8 сентября 2026 года с уточнением общей реверсивной очереди выбора от
9 сентября. Их реализация ещё предстоит; текущий технический сценарий ниже
сохраняет ограничения на двух игроков и не распределяет карты.
