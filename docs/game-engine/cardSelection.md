...
Дуэльные макеты 7–8 сентября ещё объединяют два последовательных выбора
одного игрока в шаг с двумя картами. По уточнению от 9 сентября каждый выбор
одной карты подтверждается отдельно; порядок получения карт сохраняется.
