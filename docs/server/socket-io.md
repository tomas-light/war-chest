...
создания игры и после каждого сохранённого изменения существующей игры. Клиент
использует сообщение как сигнал заново запросить `GET /api/games`: добавление
игры, смена состава, запуск и удаление завершённой игры не требуют ручного
обновления страницы.
